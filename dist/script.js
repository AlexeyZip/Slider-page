...
var _require = __webpack_require__(/*! ./slider */ "./src/js/modules/slider/slider.js"),
...
function (_Slider) {
  ...
  _createClass(MiniSlider, [{
    ...
    value: function nextSlide() {
      if (this.slides[1].tagNmae == "BUTTON" && this.slides[2].tagName == "BUTTON") {
        this.container.appendChild(this.slides[0]);
        this.container.appendChild(this.slides[1]);
        this.container.appendChild(this.slides[2]);
        this.decorizeSlides();
      } else if (this.slides[1].tagNmae == "BUTTON") {
        this.container.appendChild(this.slides[0]);
        this.container.appendChild(this.slides[1]);
        this.decorizeSlides();
      } else {
